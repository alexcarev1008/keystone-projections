...
generated: 2026-09-18T01:52:12+00:00
...
- `keystone/league.py` — League-season constants. VERIFIED REFERENCE (tests: backend/tests/test_league.py).  (key: stage_league_rates(), hitter_constants(), pitcher_constants(), projection_logit())
